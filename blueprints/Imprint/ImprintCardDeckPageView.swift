...
#Preview {
    ImprintCardDeckPreview()
        .frame(width: 240, height: 320)
}

struct ImprintCardDeckPreview: View {
...
@available(iOS 16.0, *)
public struct ImprintCardDeckPageViewStyle: PageViewStyle {
    public init() {}
    
    public func makeBody(configuration: Configuration) -> some View {
        ImprintCardDeckPageView(configuration)
    }
}

struct ImprintCardDeckPageView: View {
...
@available(macOS, unavailable)
public extension PageViewStyle where Self == ImprintCardDeckPageViewStyle {
    static var customCardDeck: ImprintCardDeckPageViewStyle {
        ImprintCardDeckPageViewStyle()
    }
}
